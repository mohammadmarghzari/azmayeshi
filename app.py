...
def bp_layout(title="", xt="", yt="", h=450):
    return dict(
        ...
        paper_bgcolor="#08111f", plot_bgcolor="#08111f",
        font=dict(color="#e8f4fd", family="Courier New", size=10),
        xaxis=dict(title=xt, gridcolor="rgba(79,195,247,0.08)", linecolor="rgba(255,255,255,0.15)",
                   tickfont=dict(color="#4fc3f7", size=9), titlefont=dict(color="#4fc3f7"), zeroline=False),
        yaxis=dict(title=yt, gridcolor="rgba(79,195,247,0.08)", linecolor="rgba(255,255,255,0.15)",
                   tickfont=dict(color="#4fc3f7", size=9), titlefont=dict(color="#4fc3f7"),
                   zeroline=True, zerolinecolor="rgba(79,195,247,0.25)", zerolinewidth=1),
        legend=dict(bgcolor="rgba(8,17,31,0.85)", bordercolor="rgba(255,255,255,0.12)",
                    borderwidth=1, font=dict(color="#e8f4fd", size=9)),
