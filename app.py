...
def calculate_portfolio():
    ...
    info_opt = option_strategies[opt]  # حالا درست کار می‌کنه
...
# ==================== استراتژی‌های هجینگ + آپشن (کامل و درست) ====================
hedge_strategies = {
...
# پیش‌فرض‌ها
defaults = {"rf_rate": 18.0, "max_btc": 25, "hedge_strategy": "Barbell طالب (۹۰/۱۰)", "option_strategy": "بدون آپشن"}
...
st.sidebar.markdown("""
<style>
    .hedge-table td, .hedge-table th {padding: 12px !important; text-align: center !important; font-size: 15px !important;}
    .hedge-table tr:nth-child(even) {background-color: #f0f8f0;}
    .hedge-table tr:hover {background-color: #e6f3e6; font-weight: bold;}
    .hedge-table th {background-color: #2e8b57 !important; color: white !important;}
</style>
...
st.sidebar.markdown("""
<style>
    .option-table td, .option-table th {padding: 12px !important; text-align: center !important; font-size: 15px !important;}
    .option-table tr:nth-child(even) {background-color: #f0f0ff;}
    .option-table tr:hover {background-color: #e6e6ff; font-weight: bold;}
    .option-table th {background-color: #4169e1 !important; color: white !important;}
</style>
""", unsafe_allow_html=True)
...
st.balloons()
st.caption("Portfolio360 Ultimate – نسخه نهایی با جدول‌های فوق‌العاده زیبا | با عشق برای ایران")
