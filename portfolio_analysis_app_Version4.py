...
if is_all_assets_valid(all_assets):
    ...
    # ============ بقیه کد مطابق سوال قبلی باقیست ===============

    # --- ادامه: مرز کارا، married put، پیش‌بینی قیمت و ... مطابق سورس قبلی ---
    # این بخش تغییری نکرده فقط بالای آن نمودارهای سبک‌های مختلف افزوده شده‌اند
    ...
    # Married Put و پیش‌بینی قیمت مطابق سورس قبلی...
